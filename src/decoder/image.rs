...
impl Image {
    ...
    pub(crate) fn expand_chunk(
        ...
        if output_width == data_dims.0 as usize && padding_right == 0 {
            let row_buffer_units: usize = crate::util::usize_div_ceil(data_dims.0 as usize * samples * self.bits_per_sample as usize, byte_len * 8);
            ...
            let row_buffer_units: usize = crate::util::usize_div_ceil(data_dims.0 as usize * samples * self.bits_per_sample as usize, byte_len * 8);
            let output_buffer_units = crate::util::usize_div_ceil(output_width * samples * self.bits_per_sample as usize, byte_len * 8);
            let row_with_padding_buffer_units = crate::util::usize_div_ceil((data_dims.0 as usize + padding_right as usize) * samples * self.bits_per_sample as usize, byte_len * 8);
            for row in 0..data_dims.1 as usize {
